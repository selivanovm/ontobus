...
import ru.magnetosoft.magnet.messaging.AMQPMessagingManager;
...
public class Autotest
{
    ...
    public String autotest_file = null;
    public long count_repeat = 1;
    public boolean nocompare = false;
    public String queue = "semargl-a";
    ...
    Autotest() throws Exception
    {
        mm = new AMQPMessagingManager();

        String host = "192.168.150.44";
        Integer port = 5672;
        String virtualHost = "big-archive";
        String userName = "ba";
        String password = "123456";
        long responceWaitingLimit = 0;
...
//                    System.out.println(message);
                    ...
                    String templ = "<magnet-ontology/transport/message#reply_to>";
