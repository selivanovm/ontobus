...
rm *.test
rm *.agent
dmd -version=tango_99_7 -Iimport src/*.d src/scripts/*d lib/mom_client.a lib/librabbitmq_client.a lib/librabbitmq.a lib/TripleStorage.a -O -release -ofSemargl.test
