...
rm *.test
rm *.agent
dmd -Iimport src/*.d src/scripts/*d src/tango/io/device/*.d lib/mom_client.a lib/librabbitmq_client.a lib/librabbitmq.a lib/TripleStorage.a -O -release -ofSemargl.test
